...
Geolocation = function() {
    ...
    var e = []
      ...
      , u = function(u, l) {
        if (!u)
            return void alert("请输入key！");
        if (!l)
            return void alert("请输入referer！");
        var p = document.getElementById(n);
        if (!p) {
            i.setAttribute("id", n),
            i.setAttribute("allow", "geolocation");
            var g = "https:";
            i.setAttribute("src", g + "//apis.map.qq.com/tools/geolocation?key=" + u + "&referer=" + l),
            i.setAttribute("style", "display: none; width: 100%; height: 30%"),
            document.body ? document.body.appendChild(i) : document.write(i.outerHTML);
            var m = this;
    ...
    u.prototype.getOnceLocation = function() {
        ...
        document.getElementById(n).contentWindow.postMessage("getLocation", "*")
    }
    ,
    ...
    u.prototype.watchPosition = function(e) {
        t = e,
        document.getElementById(n).contentWindow.postMessage("watchPosition", "*")
    }
    ,
    u.prototype.clearWatch = function() {
        t = null,
        document.getElementById(n).contentWindow.postMessage("clearWatch", "*")
    }
    ,
    u
}();
